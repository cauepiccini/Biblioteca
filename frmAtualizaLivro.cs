...
{
    public partial class frmAtualizaLivro : Form
    {
        public frmAtualizaLivro()
        {
            InitializeComponent();
        }
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            frmAlteraLivro alt = new frmAlteraLivro();
        ...
        private void frmAtualizaLivro_Load(object sender, EventArgs e)
        {
